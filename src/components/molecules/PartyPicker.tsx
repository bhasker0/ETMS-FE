    ...
    <div ref={wrapperRef} className="space-y-1 relative">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-white border border-slate-300 rounded-lg pl-9 pr-16 py-2 text-sm text-slate-900 focus:outline-none focus:border-[#0099B8] font-medium"
        />
          ...
          {filteredParties.map((p) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left p-2.5 flex items-center justify-between transition hover:bg-cyan-50/60 ${isSelected ? 'bg-cyan-50' : ''}`}
              >
                ...
                {isSelected && <Check className="w-4 h-4 text-[#0099B8]" />}
              </button>
            );
          })}
